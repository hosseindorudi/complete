...
const TableParent = ({width}) => {
    ...
    const [arrowTogle, setArrowToggle] = useState(false);
    const [opacityToggle, setOpacityToggle] = useState("");
        ...
        style={{ marginRight: sideBar ? 250 : 0 }}>
            ...
            <div className='parentMain'>
                ...
                <tr className="widgetLgTr">
                    <th className="widgetLgTh" ><div><p>نام</p><div className='arrowIcons'><div className='arrowUP' onClick={() => {setArrowToggle(true); setOpacityToggle("name"); setChoose('down');setOpacityToggle(!opacityToggle)}} style={{opacity : (opacityToggle === "name" && arrowTogle) ? 1 : .3, display: (choose !== 'up' && choose !== '') ? 'none': 'block'}}><i className="fa fa-chevron-circle-up" aria-hidden="true">d</i></div><div className='arrowDOWN' onClick={() => {setArrowToggle(true); setOpacityToggle("name"); setChoose('up')}} style={{opacity : (opacityToggle === "name" && arrowTogle) ? 1 : .3, display: (choose !== 'down' && choose !== '') ? 'none': 'block'}}><i className="fa fa-chevron-circle-down" aria-hidden="true">a</i></div></div></div></th>
